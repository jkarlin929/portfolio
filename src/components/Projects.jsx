    ...
    <Jumbotron id="projectsTitle">Projects</Jumbotron>
      <Grid>
        <Row>
          ...
          <Col xs={12} sm={6} md={6}>
          <Well bsSize="large">
            <h2><i className="fas fa-bicycle"></i> CitiBike Locator</h2>
              ...
              <a href="https://citibikers.herokuapp.com/">| <i className="fas fa-external-link-alt"></i> CitiBike Locator | </a>
              <a href="https://github.com/jkarlin929/citibike">| <i className="fab fa-github"></i> Repository | </a>
            </Well>
          </Col>
          <Col xs={12} sm={6} md={6}>
          <Well bsSize="large">
          <h2><i className="fas fa-user-astronaut"></i> Astronomer's Guide </h2>
            ...
            <a href="https://astronobject.herokuapp.com/"> | <i className="fas fa-external-link-alt"></i> Astronomer's Guide | </a>
